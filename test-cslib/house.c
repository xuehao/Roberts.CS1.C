...
void
DrawOutline(double x, double y);
void
DrawWindows(double x, double y);
void
DrawDoor(double x, double y);
void
DrawBox(double x, double y, double width, double height);
void
DrawTriangle(double x, double y, double base, double height);
void
...
DrawDoor(double x, double y)
{
  ...
  DrawCenteredCircle(
    x + DoorWidth - DoorknobInset, y + DoorHeight / 2, DoorknobRadius);
}
...
DrawWindows(double x, double y)
{
  ...
  DrawGrid(xleft - PaneWidth * 1.5,
           y + FirstFloorWindows,
           PaneWidth,
           PaneHeight,
           3,
           2);
  DrawGrid(xright - PaneWidth * 1.5,
           y + FirstFloorWindows,
           PaneWidth,
           PaneHeight,
           3,
           2);
  DrawGrid(
    xleft - PaneWidth, y + SecondFloorWindows, PaneWidth, PaneHeight, 2, 2);
  DrawGrid(
    xright - PaneWidth, y + SecondFloorWindows, PaneWidth, PaneHeight, 2, 2);
}
...
void
DrawGrid(double x, double y, double width, double height, int columns, int rows)
{
  int i, j;
